...
void LidarNdtOdometry::RegisterPubSub() {
  pub_global_map_ =
      nh_->create_publisher<sensor_msgs::msg::PointCloud2>("ndt_odometry/global_map", 1);
  pub_current_cloud_ =
      nh_->create_publisher<sensor_msgs::msg::PointCloud2>("ndt_odometry/cur_cloud", 1);
  pub_laser_odometry_ =
      nh_->create_publisher<nav_msgs::msg::Odometry>("ndt_odometry/laser_odom", 10);
}
